...
# PASSWORDS WILL BE ENCRYPTED AND STORED IN A .CSV FILE
# USER WILL BE ABLE TO ADD, REMOVE, MODIFY, AND SEARCH FOR ACCOUNTS INFORMATION

# TO DO LIST:
#   ADD SUPPORT FOR USING DATABASE LIKE SQLITE3
...
while action != 'exit':
    ...
    # DELETES AN ACCOUNT BASED ON NAME
        ...
        confirmDelete = raw_input("Are you sure you want to delete account '%s'?" % accountToDelete).lower()
